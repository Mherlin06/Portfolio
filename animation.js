...
const medias = document.querySelectorAll('.logo-btn');
...
window.addEventListener('load', () => {
    ...
    .from(contact, 1, {opacity:0, ease: "power2.out"})
    .staggerFrom(medias, 1, {opacity:0, ease: "power2.out"}, 0.5)
...
function writer(){
    ...
    .pauseFor(300)
    .typeString('<span style="color: #f4ac9f">Amateur Photographer, </span><br>')
    .pauseFor(1000)
    .typeString('<span style="color: #5c7457">Globe-trotter, </span><br>')
    .pauseFor(1000)
